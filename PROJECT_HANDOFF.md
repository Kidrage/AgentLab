...
full repository is 2886/0 with 2 skips. Phase 2R is ready for a direct Worker
chain preflight; dispatch follows only after distinguishing model/worker health
from AgentLab wrapper timeout behavior. Gate 1
