...
CRITICAL_FILES = [
    ...
    "agentlab.sh",
    "agent_runtime/brain/__init__.py",
    "agent_runtime/brain/mission_contract.py",
    "agent_runtime/brain/task_compiler.py",
    "agent_runtime/brain/domain_workflows.py",
    "agent_runtime/brain/domain_signals.py",
    "agent_runtime/brain/artifact_builder.py",
    "agent_runtime/brain/acceptance_builder.py",
    "agent_runtime/brain/risk_builder.py",
    "agent_runtime/brain/assumption_builder.py",
    "agent_runtime/domain_workflows/models.py",
    "agent_runtime/domain_workflows/loader.py",
    "agent_runtime/domain_workflows/matcher.py",
    "agent_runtime/domain_workflows/planner.py",
    "agent_runtime/domain_workflows/renderer.py",
    ...
    "docs/MISSION_CONTRACT.md",
    "docs/TASK_COMPILER.md",
    "docs/DOMAIN_WORKFLOW_TEMPLATES.md",
    "docs/S2_DOMAIN_WORKFLOW_TEMPLATES.md",
    "docs/S0_STABLE_BASELINE.md",
    "examples/mission_contracts/audio_music_generation.yml",
    "examples/mission_contracts/coding_bugfix.yml",
    "examples/mission_contracts/creative_longform.yml",
    "examples/mission_contracts/multimodal_image_review.yml",
    "examples/mission_contracts/research_company.yml",
    "scripts/audit_text_integrity.py",
    "scripts/check_remote_raw_integrity.py",
    "scripts/compile_mission_contract.py",
    "scripts/s0_stable_baseline_check.py",
    "tests/test_mission_contract_schema.py",
    "tests/test_task_compiler_mvp.py",
    "tests/test_domain_workflow_templates.py",
    "tests/test_task_compiler_domain_refinement.py",
    ...
    "tests/test_s0_stable_baseline.py",
]
...
MIN_LINES = {
    ...
    "tests/test_remote_raw_integrity_cli.py": 60,
