...
def create_task_packet(phase_plan_path: Path, executor_type: str, out_dir: Path) -> dict:
    ...
    packet = {
        "task_packet": {
            ...
            "project_type": phase.get("project_type"),
            "task_id": phase.get("task_id"),
            "phase_id": phase_id,
            "executor_type": executor_type,
            "roles": phase.get("roles") or [],
            "available_workers": phase.get("available_workers"),
            "approved_workers": phase.get("approved_workers") or [],
            "required_capabilities": phase.get("required_capabilities") or [],
            "assignment_mode": phase.get("assignment_mode"),
            "tier": phase.get("tier"),
