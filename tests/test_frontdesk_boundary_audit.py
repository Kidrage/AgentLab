...
def test_frontdesk_boundary_audit_reports_role_chain_and_raw_live_adapter_warning() -> None:
    ...
    assert report["frontdesk_agent"] == "hermes"
    assert by_id["hermes_deepseek_v4_pro_is_default_frontdesk"]["status"] == "pass"
    ...
    assert by_id["grok_cli_is_registered_as_internal_artifact_worker"]["status"] == "pass"
